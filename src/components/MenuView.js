...
export function renderMenuView(container, { totalStars, onPlay, onSelectLevel, onInfo, onStats, onSettings, onAchievements, onComingSoon }) {
  container.innerHTML = `
  ...
  renderHomeBottomNav(container.querySelector('.home-bottom-nav-wrap'), {
    onNavigate: (id) => {
      if (id === 'achievements') onAchievements();
      else onComingSoon();
    },
  });
